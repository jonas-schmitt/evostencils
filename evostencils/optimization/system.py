...
class Optimizer:
    def __init__(self, op: system.Operator, approximation: system.Approximation, rhs: system.Approximation, dimension, coarsening_factor,
                 interpolation: system.Prolongation, restriction: system.Restriction, min_level, max_level,
