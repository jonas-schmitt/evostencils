...
tmp = base.Multiplication(restriction, tmp)
coarse_approximation = system.get_coarse_approximation(approximation, coarsening_factors)
coarse_rhs = system.get_coarse_approximation(rhs, coarsening_factors)
cycle = base.Cycle(coarse_approximation, coarse_rhs, tmp)
