...
from scripts.plot_computational_graph import get_sub, get_super
...
generate = "PrimitiveSet"  # "GraphRepresentation"
...
if generate == "GraphRepresentation":
    ...
    program = ProgramGeneratorFAS('FAS_2D_Basic', 'Solution', 'RHS', 'Residual', 'Approximation',
                                  'RestrictionNode', 'CorrectionNode',
                                  'Laplace', 'gamSten', 'mgCycle', 'CGS', 'Smoother',
                                   build_path=base_path, platform_file=platform_path,
                                   exastencils_compiler=compiler_path)
    ...
    for _ in range(20):
        ...
        time_solution, convergence_factor, n_iterations = program.generate_and_evaluate(obj[0], evaluation_samples=1)
